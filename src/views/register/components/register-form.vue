<template>
    <div class="register-form-wrapper">
        ...
        <a-form ref="registerForm" :model="userInfo" :rules="rules" class="register-form" layout="vertical" @submit="handleSubmit">
            ...
            <a-form-item field="email" :validate-trigger="['change', 'blur']" hide-label>
                <a-input v-model="userInfo.email" class="cus-input" :placeholder="$t('register.form.email.placeholder')">
                    <template #prefix>
                        <icon-email />
                    </template>
                </a-input>
            ...
            <a-form-item field="password" :validate-trigger="['change', 'blur']" hide-label>
                <a-input-password v-model="userInfo.password" class="cus-input" :placeholder="$t('register.form.password.placeholder')" allow-clear>
                    <template #prefix>
                        <icon-lock />
                    </template>
                </a-input-password>
            </a-form-item>
            <a-form-item field="repassword" :validate-trigger="['change', 'blur']" hide-label>
                <a-input-password v-model="userInfo.repassword" class="cus-input" :placeholder="$t('register.form.repassword.placeholder')" allow-clear>
                    <template #prefix>
                        <icon-lock />
                    </template>
                </a-input-password>
            ...
            <a-row class="grid-demo" justify="space-between">
                ...
                <a-link type="text" class="register-form-register-btn" @click="handleRedirectToLoginPage">
